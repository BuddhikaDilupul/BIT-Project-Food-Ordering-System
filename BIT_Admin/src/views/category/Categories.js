...
const Categories = () => {
  ...
  const handleLoadCategory = async () => {
    try {
      const _data = await fetch(`http://localhost:4041/api/category/list`, {
        method: 'GET',
        headers: {
  ...
  const search = async () => {
    ...
    try {
      const _data = await fetch(`http://localhost:4041/api/search/category`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + localStorage.getItem('authToken'),
  ...
  const handleDeleteData = async (props) => {
    ...
    try {
      ...
      const _data = await fetch('http://localhost:4041/api/category/delete/' + id, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + localStorage.getItem('authToken'),
