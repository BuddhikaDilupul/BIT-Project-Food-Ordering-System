...
const Products = () => {
  ...
  const handleLoadProduct = async () => {
    try {
      const _data = await fetch(`http://localhost:4041/api/product/list`, {
        method: 'GET',
        headers: {
      ...
      const _dataCategory = await fetch(`http://localhost:4041/api/category/list`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + localStorage.getItem('authToken'),
  ...
  const search = async () => {
    ...
    try {
      const _data = await fetch(`http://localhost:4041/api/search/product`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + localStorage.getItem('authToken'),
  ...
  const handleDeleteData = async (props) => {
    try {
      ...
      const _data = await fetch('http://localhost:4041/api/product/delete/' + id, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + localStorage.getItem('authToken'),
